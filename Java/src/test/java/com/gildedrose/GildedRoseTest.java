...
public class GildedRoseTest {
    ...
    public void testTwoDays(){
        ...
        for (int i = 0; i < itemsEnd.length ; i++) {
            assertEquals(String.format("%s",itemsEnd[i].getName()),itemsEnd[i].getName(),app.getItems()[i].getName());
            assertEquals(String.format("%s",itemsEnd[i].getName()),itemsEnd[i].getQuality(),app.getItems()[i].getQuality());
            assertEquals(String.format("%s",itemsEnd[i].getName()),itemsEnd[i].getSellIn(),app.getItems()[i].getSellIn());
        }
